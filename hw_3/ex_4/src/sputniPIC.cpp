...
int main(int argc, char **argv){
    ...
    for (int cycle = param.first_cycle_n; cycle < (param.first_cycle_n + param.ncycles); cycle++) {
        ...
        // iMover = cpuMillisecond() // tried to measure in milliseconds
        for (int is=0; is < param.ns; is++){
        ...
        //eMover += (cpuMillisecond() - iMover); // tried to measure in milliseconds
        ...
        //iInterp = cpuSecond() * 1000 ; // tried to measure in ms
        // interpolate species
        for (int is=0; is < param.ns; is++)
    ...
    // stop timer
    double iElaps = cpuSecond() - iStart; // cpuMilliseconds() // tried to measure in ms
